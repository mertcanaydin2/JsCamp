...
export default class UserService{
    ...
    name(user){
        if(user.firstName == "" || user.firstName == undefined){
            this.errors.push("İsim alanı boş bıraklıamaz",user)
            return false;
        }else{
            return true;
        }
    ...
    lastName(user){
        if(user.lastName == "" || user.lastName == undefined){
            this.errors.push("Soy isim alanı boş bırakılamaz",user)
            return false;
    ...
    city(user){
        if(user.city == "" || user.city == undefined){
            this.errors.push("Şehir alanı boş bırakılamaz",user)
            return false;
    ...
    age(user){
        if (user.age == "" || user.age == undefined){
            this.errors.push("Yaş alanı boş bırakılamaz",user)
            return false
        }
        else{
            return true
